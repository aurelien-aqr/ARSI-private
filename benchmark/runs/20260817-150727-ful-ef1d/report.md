# Benchmark run — tram1762 · full

**Run:** `20260817-150727-ful-ef1d`  
**Status:** completed (29/29 cases)  
**Dataset:** `tram1762` (digest `c0cd1ba792e8`)  
...
- False-positive regions (kept boxes matching no real anomaly): **20** of 74 kept → region precision 0.730
- Regions sent to the judge: 559 — all 559 verdicts served from cache (0 new calls).
