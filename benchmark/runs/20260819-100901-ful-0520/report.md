...
**Run:** `20260819-100901-ful-0520`  
**Status:** completed (68/68 cases)  
**Dataset:** `ground_truth` (digest `fd6c89967fbd`)  
...
- Regions sent to the judge: 983 - all 983 verdicts served from cache (0 new calls).
