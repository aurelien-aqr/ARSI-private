...
**Run:** `20260817-233445-ful-87fd`  
**Status:** completed (50/50 cases)  
**Dataset:** `ground_truth` (digest `b26d2bdf03e8`)  
...
- Cases: **50**  (TP=27, FP=0, TN=19, FN=4)
- **Accuracy** 0.920 · **Precision** 1.000 · **Recall** 0.871 · **Specificity** 1.000 · **F1** 0.931

| | predicted anomaly | predicted clean |
|---|---|---|
| **actual anomaly** | TP = 27 | FN = 4 |
| **actual clean**   | FP = 0 | TN = 19 |
...
- Regions sent to the judge: 825 - **266 fresh VLM call(s)**, 559 served from cache.
