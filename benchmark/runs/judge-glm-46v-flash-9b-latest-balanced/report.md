...
- Cases: **68**  (TP=30, FP=1, TN=36, FN=1)
- **Accuracy** 0.971 · **Precision** 0.968 · **Recall** 0.968 · **Specificity** 0.973 · **F1** 0.968

| | predicted anomaly | predicted clean |
|---|---|---|
| **actual anomaly** | TP = 30 | FN = 1 |
| **actual clean**   | FP = 1 | TN = 36 |

## 2) Object-level (did we box each real anomaly?)

- Instances detected: **55 / 73** → **object recall 0.753** (strict IoU≥0.3: 46 / 73 = 0.630)
- False-positive regions (kept boxes matching no real anomaly): **8** of 68 kept → region precision 0.882
- Uncached VLM calls this run: 599, mean 0.6 s/call
...
|---|---|---|---|---|---|
| 3333_cam52_084637\* | anomaly | **TP** | 1/3 | 0 | a purple bag |
| 3333_cam52_085124 | anomaly | **TP** | 1/2 | 2 | wallet, wallet, phone |
| 3333_cam53_083517 | anomaly | **TP** | 1/2 | 0 | yellow bag |
| 3333_cam53_084021 | anomaly | **TP** | 1/2 | 0 | yellow bag |
| 3333_cam53_084637 | anomaly | **TP** | 1/1 | 0 | bottle |
| 3333_cam53_085124 | anomaly | **TP** | 1/1 | 0 | pink item hanging from pole |
| 3333_cam54_084021 | anomaly | **TP** | 1/1 | 0 | plastic bag |
| 3333_cam54_084637 | anomaly | **TP** | 2/2 | 0 | cloth on seat, laptop |
| 3333_cam54_085124 | anomaly | **TP** | 3/3 | 1 | crumpled bag, plastic bag and bottle, green bottle, laptop |
| 3333_cam55_083517 | anomaly | **TP** | 2/2 | 0 | a crumpled bag, a laptop |
| 3333_cam55_084021 | anomaly | **TP** | 2/2 | 0 | plastic bag, a book |
| 3333_cam55_084637 | anomaly | **TP** | 2/2 | 0 | cloth on seat, laptop |
| 3333_cam55_085124 | anomaly | **TP** | 2/2 | 0 | bottle and package, a green bottle and an open laptop |
...
| gpt_03_faint_tag | anomaly | **TP** | 1/1 | 0 | "graffiti 'XRP'" |
| gpt_04_graffiti | anomaly | **TP** | 1/1 | 0 | colorful graffiti, colorful graffiti, graffiti, purple graffiti scribble |
| gpt_05_slash | anomaly | **TP** | 1/1 | 0 | torn seat cushion |
| gpt_07_multi | anomaly | **TP** | 4/4 | 1 | black backpack, graffiti "HOB88", torn seat cushion, plastic bottle, plastic bottle |
| gpt_08_phone_tag | anomaly | **TP** | 2/2 | 0 | graffiti "Zo9k", wallet |
| gpt_09_litter | anomaly | **TP** | 1/1 | 0 | litter (cans and paper), three small rectangular items, two cans, can and wrappers, small crumpled paper wrapper |
| gpt_10_litter | anomaly | **TP** | 1/1 | 0 | litter (can, papers) |
| gpt_11_crowd | anomaly | **TP** | 4/4 | 2 | black backpack, plastic bottle, graffiti "HOBBO", torn seat cushion, plastic bottle, graffiti |
| real_f0037 | anomaly | **TP** | 1/4 | 0 | backpack |
| real_f0053 | anomaly | **TP** | 1/4 | 0 | black backpack |
| real_f0100 | anomaly | **TP** | 2/4 | 0 | black backpack, phone |
| real_f0112 | anomaly | **TP** | 2/4 | 0 | black backpack, black phone |
| real_f0205 | anomaly | **TP** | 1/2 | 0 | jacket on seat |
| real_f0219 | anomaly | **TP** | 2/2 | 0 | jacket on seat, black backpack |
| variant_01 | anomaly | **TP** | 6/7 | 0 | backpack, bottle, torn seat, graffiti "KEPP", torn seat |
| 3333_cam54_083517 | anomaly | **FN** | 0/1 | 0 | - |
| 3333_cam53_085954_clean | clean | **FP** | - | 1 | shoes and bag |
...
Annotated images: `benchmark/runs/cli-latest/annotated/<id>.jpg` (blue = ground-truth boxes, green = correct detections, red = false-positive boxes). Raw results: `benchmark/runs/judge-glm-46v-flash-9b-latest-balanced/results.json`.
