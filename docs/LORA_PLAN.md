...
On volume: aim for somewhere between 300 and 500 crops. The Borodin paper saw
gains at that scale on a task narrower than ours, so treat it as a floor rather
than a target, and keep labelling as a side effect of normal Studio use.
